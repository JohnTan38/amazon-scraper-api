...
const apiKey = '821b718bed97b664db1f290007976a6d';
const baseUrl = 'http://api.scraperapi.com?api_key=821b718bed97b664db1f290007976a6d&autoparse=true';
...
// Get product reviews
app.get('/products/:productId/product-reviews', async (req, res) => {
    const { productId } = req.params;
    const { api_key } = req.query;
